...
if (isset($_POST['digit1']) && isset($_POST['digit2']) && isset($_POST['digit3']) && isset($_POST['digit4']) && isset($_POST['digit5']) && isset($_POST['digit6'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $storedOTP = $row['reset_code'];

        if ($enteredOTP === $storedOTP) {
            // OTP verification successful, redirect to Change Password page
        ...
        // User not found, redirect back to forgot password page
        header("Location: Forgotpass.php?error=user_not_found");
        exit();
    }
}
?>
