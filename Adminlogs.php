...
// Create connection
$connection = new mysqli($servername, $username, $password, $dbname); // corrected variable name here
...
$sql = "SELECT * FROM AdminLogs"; // Changed table name to AdminLogs
...
<div class="container my-5">
    ...
    <div class="mb-3">
        <select id="sortSelect" class="form-select">
            ...
            <option value="admin_id">Sort by Admin ID</option>
            <option value="log_type">Sort by Log Type</option>
            <option value="log_timestamp">Sort by Timestamp</option>
        </select>
    </div>
...
<script>
    ...
    document.getElementById('sortSelect').addEventListener('change', function() {
        ...
        rowsArray.sort((a, b) => {
            ...
            if (sortBy === 'log_id' || sortBy === 'log_timestamp') {
    ...
    function getColumnIndex(sortBy) {
        switch(sortBy) {
            case 'log_id': return 1;
            case 'admin_id': return 2;
            case 'log_type': return 3;
            case 'log_timestamp': return 5;
            default: return 1;
        }
    }
</script>
